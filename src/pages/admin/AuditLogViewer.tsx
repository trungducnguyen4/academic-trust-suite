...
const mockLogs: AuditLog[] = [
  {
    ...
    ip: "10.0.1.15",
    severity: "warning",
    details: "Changed global similarity threshold from 75% to 80%",
  },
  {
    id: "LOG-002",
    ...
    role: "lecturer",
    action: "Exam Created",
    resource: "Final Exam - CS101",
    ip: "192.168.1.42",
    severity: "info",
    details:
      "Created exam with 40 questions, 90min duration, fullscreen enforced",
  },
  {
    id: "LOG-003",
    ...
    resource: "Midterm - CS201",
    ip: "172.16.0.88",
    severity: "critical",
    details:
      "Tab switch count exceeded threshold (8/5). Auto-flagged for review.",
  },
  {
    id: "LOG-004",
    ...
    ip: "10.0.1.15",
    severity: "warning",
    details: "Changed role from student to lecturer",
  },
  {
    id: "LOG-005",
    ...
    resource: "Question Bank - CS101",
    ip: "192.168.1.42",
    severity: "info",
    details: "Deleted question Q-412 (Multiple Choice)",
  },
  {
    id: "LOG-006",
    timestamp: "2024-01-15 13:22:33",
    user: "student2@university.edu",
    role: "student",
    action: "Login",
  ...
  {
    id: "LOG-007",
    timestamp: "2024-01-15 13:10:15",
    user: "admin@university.edu",
    role: "admin",
    action: "User Suspended",
    resource: "User: suspect@edu",
    ip: "10.0.1.15",
    severity: "critical",
    details: "Account suspended due to multiple integrity violations",
  },
  {
    id: "LOG-008",
    timestamp: "2024-01-15 12:58:40",
    user: "lecturer@university.edu",
    role: "lecturer",
    action: "Exam Link Generated",
    resource: "Final Exam - CS101",
    ip: "192.168.1.42",
    severity: "info",
    details:
      "Generated exam link with code EXAM-2024-A1. Max usage: 50. Expiry: 7 days.",
  },
  {
    id: "LOG-009",
    timestamp: "2024-01-15 12:45:00",
    user: "student3@university.edu",
    role: "student",
    action: "Login Failed",
    resource: "Authentication",
    ip: "203.0.113.55",
    severity: "warning",
    details: "Failed login attempt (3/5). Wrong password.",
  },
  {
    id: "LOG-010",
    timestamp: "2024-01-15 12:30:22",
    user: "admin@university.edu",
    role: "admin",
  ...
  },
  {
    ...
    ip: "172.16.0.88",
    severity: "info",
    details: "Submitted 35/40 questions. Duration: 78min. Score: 7.5/10",
  },
  {
    id: "LOG-012",
    timestamp: "2024-01-15 11:55:44",
    user: "lecturer2@university.edu",
    role: "lecturer",
    action: "AI Generation",
    resource: "Question Bank - ML301",
    ip: "192.168.1.60",
    severity: "info",
    details:
      "Generated 15 questions from uploaded PDF (12 approved, 3 rejected)",
  },
  {
    id: "LOG-013",
    timestamp: "2024-01-15 11:30:00",
    user: "student4@university.edu",
    role: "student",
    action: "Integrity Flag",
    resource: "Quiz - MATH101",
    ip: "172.16.0.95",
    severity: "critical",
    details: "Answer similarity 92% detected with student5@university.edu",
  },
  {
    id: "LOG-014",
    timestamp: "2024-01-15 11:10:20",
    user: "admin@university.edu",
    role: "admin",
    ...
    ip: "10.0.1.15",
    severity: "warning",
    details: "Maintenance mode enabled for scheduled update",
  },
  {
    id: "LOG-015",
            ...
            {selectedLog && (
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <p className="bg-muted rounded p-3 mt-1">
                    {selectedLog.details}
                  </p>
                </div>
              </div>
