    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-muted-foreground">Admins can view more details in the admin console. For operators, see <Link to="/admin/system-policy">System Policy</Link> and the repo <Link to="/docs/ops/retention">retention runbook</Link> (internal).</p>
