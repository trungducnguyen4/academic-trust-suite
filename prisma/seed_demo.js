...
async function main(){
  ...
  await prisma.user.upsert({
    ...
    create: {
      email: 'admin@tdhuhu.edu.vn', password: hashed, fullName: 'Admin', role: 'ADMIN', department: 'IT'
    }
  });
  ...
  const lecturer = await prisma.user.upsert({
    ...
    update: { password: hashed },
    create: { email: 'lecturer01@tdhuhu.edu.vn', password: hashed, fullName: 'Lecturer 01', role: 'LECTURER', department: 'Computer Science' }
  });

  await prisma.user.upsert({
    where: { email: '522h0001@tdhuhu.edu.vn' },
    update: { password: hashed },
    create: { email: '522h0001@tdhuhu.edu.vn', password: hashed, fullName: 'Demo Student 522h0001', role: 'STUDENT', studentId: '522h0001' }
  });
